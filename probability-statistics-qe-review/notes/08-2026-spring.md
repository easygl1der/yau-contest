...
> - 官方原卷：[qzc-qe-probability-statistics-2026-spring.pdf](../sources/exams/qzc-qe-probability-statistics-2026-spring.pdf)
> - MinerU 阅读包：[完整转录](../transcripts/mineru/qzc-qe-probability-statistics-2026-spring/reading.md)；原始 Markdown、JSON 和图像资产位于同一目录下的 `parts/`。
