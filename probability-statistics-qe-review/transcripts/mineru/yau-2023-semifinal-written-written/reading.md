...
1. The sequence $(X_{1}, X_{2}, \ldots, X_{n}, \ldots)$ is a Dirichlet process with base distribution $G_{0}$ and concentration parameter $\alpha_{0} > 0$ if $G_{0}$ is a probability distribution on R and satisfies:
...
3. Let $X_{1}, X_{2}, \ldots, X_{n}$ be a sequence of i.i.d. random variables with a uniform distribution on (0, 1). Define the events $A_{1}, A_{2}, \ldots$ by
