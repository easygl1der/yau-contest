...
Problem 1. Let $X_{1}, \cdots, X_{n}$ be n independent and identically distributed observations from the exponential distribution with density function $\begin{array}{r}{f(x) = \frac{1}{\beta} e^{- x / \beta}, x \ge 0} \end{array}$
...
Problem 1. Let $X_{1}, \cdots, X_{n}$ be n independent and identically distributed observations from the Cauchy distribution with density function $\begin{array}{r}{f(x) = \frac{1}{\pi} \frac{1}{1 +(x - \theta)^{2}}, x \in \mathbb{R}} \end{array}$
...
Problem 1. Let $X_{i} \sim N(\theta_{i},{\frac{1}{n}}), i = 1, \cdots, n$ , be independent. Find an estimator $\widehat{T}$ of $\textstyle T = \sum_{i = 1}^{n} \theta_{i}^{2}$ and calculate $E(\widehat{T} - T)^{2}$