...
1) Suppose $(X_{n})_{n \geq 1}$ is a sequence of positive random variables. There exists a constant $C > 0$ such that,
...
2) Suppose $\gamma$ is a probability measure on {0, 1, 2} such that $\gamma(0) > \gamma(2) > 0$ . Let $(\xi_{n})_{n \geq 1}$ be a sequence of i.i.d. random variables with common law $\gamma.$ Define the sequence
...
3) Suppose $(\epsilon_{n})_{n \geq 1}$ is a sequence of i.i.d. random variables and the common law is Bernoulli:
