...
(b) $X _ { n } Y _ { n }$ converges to cX in distribution.
...
4. Is $\hat { \sigma } = c M$ asymptotically eficient? Please justify your answer.
...
$$
E _ {(r)} \stackrel {{D}} {{=}} \sum_ {j = 1} ^ {r} \frac {E _ {j}}{n + 1 - j}, \qquad r = 1, \dots , n.
$$
