...
![](images/bdb4673beec36761a2716132221fff7ff7de37431cbdef1bc698cd526cde29e5.jpg)
...
$$
R _ {h} := \frac {\left(\mathbb {E} [ X _ {h} \mid X _ {0} = 1 ] - \mathbb {E} [ X _ {h} \mid X _ {0} = - 1 ]\right) ^ {2}}{V a r [ X _ {h} | X _ {0} = 1 ]}.
$$
...
Show that for each $p \in [ 0 , 1 ]$ , there exists $A _ { p }$ such that
...
Please find a non-trivial partial diferential equation for $G ( s , t )$ , which involves $\partial _ { t } G$