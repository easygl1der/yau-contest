# Yau College Math Competition 2024 Final Probability and Statistics Individual All-round Problems (June 8-9, 2024)
...
Problem 2. We have n observations $y_{i}, i = 1, \dotsc, n$ , satisfying the simple linear regression model:
