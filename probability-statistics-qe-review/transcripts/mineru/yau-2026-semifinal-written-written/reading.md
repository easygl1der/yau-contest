...
Problem 4. Let $\{B_{t}, t \ge 0\}$ be a standard Brownian motion. For $a > 0$ , define the first exit time from the interval $(- a, a)$ :
...
Problem 5. Let $X_{1}, X_{2},...$ . be i.i.d. random variables. Suppose that for some integer $n \geq 2$ , there exist constants $a > 0$ and $b \in \mathbb{R}$ such that
