...
$$
\mathbb {P} \left\{\lim _ {n \to \infty} \frac {S _ {n}}{n ^ {\alpha}} = 0 \right\} = 1.
$$
...
Let $p _ { n } = \mathbb { P } \left\{ \det X _ { N } \right.$ is odd}. Show that $\operatorname* { l i m } _ { n \to \infty } p _ { n } > 0 .$ .
