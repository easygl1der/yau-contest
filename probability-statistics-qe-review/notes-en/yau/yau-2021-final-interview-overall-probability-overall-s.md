# 2021 S.-T. Yau College Student Mathematics Competition: Final Interview (Overall)

> [!info] Sources and Transcriptions
> - Original source file: [Local copy](../../sources/yau-contest/final-interview/yau-2021-final-interview-overall-probability-overall-s.pdf).
> - Source: [Official Question Bank Download Page](https://yau-contest.com/lists-jxxg.html).
> - MinerU reading transcript: [Full transcription](../../transcripts/mineru/yau-2021-final-interview-overall-probability-overall-s/reading.md). The original Markdown, JSON, and image assets are in `parts/`.
> - Corresponding solutions: [Problem-by-problem reference solutions](../../solutions/yau/yau-2021-final-interview-overall-probability-overall-s-solutions.md).
> - Mathematical notation, figures, layout, and any OCR ambiguity are governed by the original source file.


## Question 1

^yau-2021-final-interview-overall-probability-overall-s-q1

> Corresponding solution: [Reference solution for Question 1](../../solutions/yau/yau-2021-final-interview-overall-probability-overall-s-solutions.md#^yau-2021-final-interview-overall-probability-overall-s-s1).

Let $X_{1}, X_{2}, \cdots, X_{n}$ be independent exponential random variables with parameter 1, and $X_{(1)}, X_{(2)}, \cdots, X_{(n)}$ be their order statistics. Let $X_{(0)} = 0$
...
^yau-2021-final-interview-overall-probability-overall-s-q2

> Corresponding solution: [Reference solution for Question 2](../../solutions/yau/yau-2021-final-interview-overall-probability-overall-s-solutions.md#^yau-2021-final-interview-overall-probability-overall-s-s2).
