...
source_line_start: 18104
source_line_end: 19422
...
> [[../README|本书目录]] · [[14-chapter-14-alternating-minimization|上一章]]
...
> - 原始阅读稿：[reading.md](../../../transcripts/mineru/first-order-methods-optimization/reading.md)，源行 18104–19422。
> - 本章保留 3 个提取图像；图片、公式或原文措辞有歧义时以 PDF 为准。

> [!abstract] 转录质量门
> 已完成结构、图片路径、数学定界符和高置信度 OCR 拼写检查。自动修复：Affine × 6；different × 4；Differentiability × 1；efficient × 2；sufficient × 2。本章的异常状态以 frontmatter 的 `review_status` 与本书的 [[review-log]] 为准；没有 PDF 页码映射时不会伪造页码引用。
