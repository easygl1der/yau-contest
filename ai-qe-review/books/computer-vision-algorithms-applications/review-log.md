...
| [[chapters/05-chapter-5-deep-learning|第 5 章]] | needs-manual-review | 疑似转录/渲染风险；原图无语义 alt 文本，已加回看 PDF 提示；仍需人工补充图义；46 张图使用相邻原文图注生成 alt，仍需视觉核对；已应用可追溯自动修复：PDF-confirmed control-symbol repair (PDF p.265) × 4；PDF-confirmed control-symbol repair (PDF p.326) × 2 | 5403–7106 |
