...
\begin{enumerate}
  \item 第一轮读第 \ref{ch:syllabus} 章和第 \ref{ch:primer} 章，建立四门核心课的共同符号。
  \item 第二轮按年份刷第 \ref{ch:2025spring}--\ref{ch:2026spring} 章，先自己写解，再对照推导。
  \item 第三轮按第 \ref{ch:checklists} 章的 checklist 反向查漏，重点补 PAC/VC、prox-SGD、扩散模型、policy gradient、Transformer 和 RAG/MLN。
\end{enumerate}
