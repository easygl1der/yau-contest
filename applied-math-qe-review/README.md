# 求真书院计算与应用数学博士生资格考试题库

本目录以 `ai-qe-review/` 为模板，保存清华大学求真书院公开的计算与应用数学方向博士生资格考试（QE）档案。截至 2026-07-28，官方“考题资源”页可追溯到 2023 秋至 2026 春，共 6 套公开原卷；另含 2026-06-30 发布的考试大纲。
...
- `notes-en/`：与 `notes/` 保持目录、文件名和题目顺序平行的专业英文 Obsidian 笔记。
