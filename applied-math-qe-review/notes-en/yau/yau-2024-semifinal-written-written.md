# 2024 Yau Mathematical Contest Semifinal Written Examination written

> [!info] Sources and Transcription
> - Original file: [local source file](../../sources/yau-contest/semifinal-written/yau-2024-semifinal-written-written.pdf).
> - Source: local historical problem archive; the upstream release page remains to be catalogued.
> - MinerU reading transcript: [full transcript](../../transcripts/mineru/yau-2024-semifinal-written-written/reading.md); the original Markdown, JSON, and image assets are stored in `parts/`.
> - Corresponding solutions: [Reference solutions by problem](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md).
...
> Corresponding solutions: [Problem 1 Reference Solution](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s1).

Let $A \in \mathbb{R}^{n \times n}$ be a non-singular matrix. Let u, $v \in \mathbb{R}^{n}$ be column vectors. Define the rank 1 perturbation $\widehat{A} = A \overset{\vartriangle}{+} u \boldsymbol{v}^{T}$
...
> Corresponding solutions: [Problem 2 Reference Solution](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s2).
...
> Corresponding solutions: [Problem 3 Reference Solution](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s3).
...
> Corresponding solutions: [Problem 4 Reference Solution](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s4).
...
^yau-2024-semifinal-written-written-q6

> Corresponding solutions: [Problem 6 Reference Solution](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s6).

Consider the difusion equation
