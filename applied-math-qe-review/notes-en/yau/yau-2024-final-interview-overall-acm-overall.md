# 2024 Yau Mathematical Contest Final Interview overall

> [!info] Sources and Transcription
> - Original file: [local source file](../../sources/yau-contest/final-interview/yau-2024-final-interview-overall-acm-overall.pdf).
> - Source: [official archive download page](https://yau-contest.com/lists-jxxg.html).
> - MinerU reading transcript: [full transcript](../../transcripts/mineru/yau-2024-final-interview-overall-acm-overall/reading.md); the original Markdown, JSON, and image assets are stored in `parts/`.
> - Corresponding solutions: [Reference solutions by problem](../../solutions/yau/yau-2024-final-interview-overall-acm-overall-solutions.md).
...
> Corresponding solutions: [Problem 1 Reference Solution](../../solutions/yau/yau-2024-final-interview-overall-acm-overall-solutions.md#^yau-2024-final-interview-overall-acm-overall-s1).
