# 2021 Yau Mathematical Contest Semifinal Written Examination written

> [!info] Sources and Transcription
> - Original file: [local source file](../../sources/yau-contest/semifinal-written/yau-2021-semifinal-written-written.pdf).
> - Source: local historical problem archive; the upstream release page remains to be catalogued.
> - MinerU reading transcript: [full transcript](../../transcripts/mineru/yau-2021-semifinal-written-written/reading.md); the original Markdown, JSON, and image assets are stored in `parts/`.
> - Corresponding solutions: [Reference solutions by problem](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md).
...
> Corresponding solutions: [Problem 2 Reference Solution](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md#^yau-2021-semifinal-written-written-s2).

Let $S(x)$ be a cubic spline with knots $\{t_{i}\}_{i = 0}^{n}.$ If it is determined that $S(x)$ is linear over $[t_{1}, t_{2}]$ and $[t_{3}, t_{4}]$ . Prove that S(x) is also linear over $\left[t_{2}, t_{3} \right]$

## Problem 3

^yau-2021-semifinal-written-written-q3

> Corresponding solutions: [Problem 3 Reference Solution](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md#^yau-2021-semifinal-written-written-s3).

Let $f : \mathbb{R} \mathbb{R}$ be defined by $f(x) = 2x - \cos x.$
...
> Corresponding solutions: [Problem 4 Reference Solution](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md#^yau-2021-semifinal-written-written-s4).

Let matrix $\mathbf{A} \in \mathbb{R}^{\mathbf{m} \times \mathbf{n}}$ with $m \geq n$ and $r ={\operatorname{rank}}(\mathbf{A}) < n.$ , and assume A has the following SVD decomposition
...
> Corresponding solutions: [Problem 5 Reference Solution](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md#^yau-2021-semifinal-written-written-s5).
...
> Corresponding solutions: [Problem 6 Reference Solution](../../solutions/yau/yau-2021-semifinal-written-written-solutions.md#^yau-2021-semifinal-written-written-s6).
