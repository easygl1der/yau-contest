# 2012 Yau Mathematical Contest Semifinal Written Examination team

> [!info] Sources and Transcription
> - Original file: [local source file](../../sources/yau-contest/semifinal-written/yau-2012-semifinal-written-team.pdf).
> - Source: local historical problem archive; the upstream release page remains to be catalogued.
> - MinerU reading transcript: [full transcript](../../transcripts/mineru/yau-2012-semifinal-written-team/reading.md); the original Markdown, JSON, and image assets are stored in `parts/`.
> - Corresponding solutions: [Reference solutions by problem](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md).
...
> Corresponding solutions: [Problem 1 Reference Solution](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md#^yau-2012-semifinal-written-team-s1).

If the function $u(x)$ is in $C^{k + 1}$ (has continuous $(k + 1)$ -th derivative) on the interval [0, 2], and a sequence of polynomials $p_{n}(x) \(n =$ $1, 2, 3, \ldots)$ of degree at most k satisfies
...
> Corresponding solutions: [Problem 2 Reference Solution](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md#^yau-2012-semifinal-written-team-s2).
...
> Corresponding solutions: [Problem 3 Reference Solution](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md#^yau-2012-semifinal-written-team-s3).
...
> Corresponding solutions: [Problem 4 Reference Solution](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md#^yau-2012-semifinal-written-team-s4).

The famous RSA cryptosystem is based on the assumed dificulty of factoring integers $N = pq$ (called RSA integers) which are products of two large primes $p$ and $q$ which should be kept secret. Currently $p$ and q are chosen to be about 500 bits long, that is,
...
> Corresponding solutions: [Problem 5 Reference Solution](../../solutions/yau/yau-2012-semifinal-written-team-solutions.md#^yau-2012-semifinal-written-team-s5).

The solution $h(r, t)$ of the following Boussinesq equation describes the hight of a circular drop of fluid spreading on a dry surface $h = 0$
