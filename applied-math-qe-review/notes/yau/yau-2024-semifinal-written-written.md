# 2024 丘赛 半决赛笔试 written

> [!info] 来源与转录
> - 原始文件：[本地原件](../../sources/yau-contest/semifinal-written/yau-2024-semifinal-written-written.pdf)。
> - 来源：本地历史题库；上游发布页待补录。
> - MinerU 阅读稿：[完整转录](../../transcripts/mineru/yau-2024-semifinal-written-written/reading.md)；原始 Markdown、JSON 和图像资产位于 `parts/`。
> - 对应解答：[逐题参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md)。
...
> 对应解答：[题 1 参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s1)。
...
> 对应解答：[题 2 参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s2)。
...
> 对应解答：[题 3 参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s3)。
...
> 对应解答：[题 4 参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s4)。
...
> 对应解答：[题 6 参考解](../../solutions/yau/yau-2024-semifinal-written-written-solutions.md#^yau-2024-semifinal-written-written-s6)。
