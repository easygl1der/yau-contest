...
- `source.pdf`：与 `sources/exams/qzc-qe-applied-math-2023-fall.pdf` 对应的不可变硬链接。
- `reading.md`：清理后的主阅读文件，图片路径已调整为在本目录可解析。
- `parts/qzc-qe-applied-math-2023-fall.md`：MinerU 的清理后原始 Markdown。
- `parts/qzc-qe-applied-math-2023-fall.json`：MinerU 的结构化输出。
...
- 原始 PDF SHA-256：`0c598452b8a4c6d2714f32e10bab17a3f4ea37a83e9f14a96474506ac5a13cd4`。
