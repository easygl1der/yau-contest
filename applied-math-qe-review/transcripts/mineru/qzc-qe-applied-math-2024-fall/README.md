...
- `source.pdf`：与 `sources/exams/qzc-qe-applied-math-2024-fall.pdf` 对应的不可变硬链接。
- `reading.md`：清理后的主阅读文件，图片路径已调整为在本目录可解析。
- `parts/qzc-qe-applied-math-2024-fall.md`：MinerU 的清理后原始 Markdown。
- `parts/qzc-qe-applied-math-2024-fall.json`：MinerU 的结构化输出。
...
- 原始 PDF SHA-256：`0d7426c463e10c84b2d5c625b6048a528a13821fda230d8db1651a110c068ed2`。
