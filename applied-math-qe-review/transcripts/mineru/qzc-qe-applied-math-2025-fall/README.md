...
- `source.pdf`：与 `sources/exams/qzc-qe-applied-math-2025-fall.pdf` 对应的不可变硬链接。
- `reading.md`：清理后的主阅读文件，图片路径已调整为在本目录可解析。
- `parts/qzc-qe-applied-math-2025-fall.md`：MinerU 的清理后原始 Markdown。
- `parts/qzc-qe-applied-math-2025-fall.json`：MinerU 的结构化输出。
...
- 原始 PDF SHA-256：`8a684401035cecbcedbaa05475183c500fcc18abfb55b699a332ab5b97e1e306`。
