...
- `source.pdf`：与 `sources/exams/qzc-qe-applied-math-2026-spring.pdf` 对应的不可变硬链接。
- `reading.md`：清理后的主阅读文件，图片路径已调整为在本目录可解析。
- `parts/qzc-qe-applied-math-2026-spring.md`：MinerU 的清理后原始 Markdown。
- `parts/qzc-qe-applied-math-2026-spring.json`：MinerU 的结构化输出。
...
- 原始 PDF SHA-256：`9c66470e6d42a5e641bc22408dc9f556a753b2b7dc6c78a11116726480fb4e30`。
