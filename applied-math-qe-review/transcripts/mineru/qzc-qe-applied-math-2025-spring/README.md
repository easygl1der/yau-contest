...
- `source.pdf`：与 `sources/exams/qzc-qe-applied-math-2025-spring.pdf` 对应的不可变硬链接。
- `reading.md`：清理后的主阅读文件，图片路径已调整为在本目录可解析。
- `parts/qzc-qe-applied-math-2025-spring.md`：MinerU 的清理后原始 Markdown。
- `parts/qzc-qe-applied-math-2025-spring.json`：MinerU 的结构化输出。
...
- 原始 PDF SHA-256：`c9e78f11827199917c9ca37b8036d21d0e691bbbd46081c57c50f16ffa89ec8d`。
