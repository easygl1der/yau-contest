---
title: "Qiuzhen AI QE — Fall 2025 — Problem 11 — PAC Learning of Concentric Circles"
exam: "2025-fall"
...
- Source locator: **A. Machine Learning Theory, Problem 11** in [the transcribed paper](../../../qzc-qe-ai-2025-fall.tex).
- Marks: **5**.
...
Prove realizable PAC learnability and the stated sample bound.

## Zero-background prerequisite ladder

- thresholds; nested sets; consistent learner; realizable PAC bound
...
Reduce the class to a one-parameter nested threshold problem; identify the largest consistent radius or equivalent learner; bound missed target mass.

## Exam-ready answer skeleton

State a learner as well as the probability bound.

## Self-check and common mistakes

- Self-check: Can you show why the failure event is that all samples miss a region of mass above the target error?
- Common mistake: Using a finite-class bound for an infinite nested class without justification.
