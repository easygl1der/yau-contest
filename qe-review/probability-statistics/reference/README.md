# Probability & Statistics — reference shelf

Local sources used while preparing the Qiuzhen QE. Canonical syllabus: [qzc-qe-probability-statistics-syllabus-2026-06.md](../syllabus/qzc-qe-probability-statistics-syllabus-2026-06.md).
...
| [qingshu-lagrange-mvt](./qingshu-lagrange-mvt/mineru-md/qingshu-ch7-mvt-sums.md) | 清疏 excerpts on MVT / odd harmonic sums (MinerU slices of Ch. 7–8). |
| [ren-jiagang-probability-course](./ren-jiagang-probability-course/README.md) | 任佳刚、刘继成《概率论教程》(2024 lecture notes, 300 pp., `probfinalforlecture.pdf`). Density / CDF / transforms in Ch. 4; characteristic functions in Ch. 8–9. |
| [prob_2024.pdf](./prob_2024.pdf) | Unrelated Duke MATH641 notes (Huarui Zhou / Quanjun Lang). Not the Ren course. |
