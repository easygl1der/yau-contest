...
\begin{enumerate}
    \item \textbf{Construct an auxiliary function:}
    ...
    \item \textbf{Examine the derivatives:}
    ...
    \item \textbf{Apply the Luzin N property:}
    ...
    \item \textbf{Conclude the constant nature of H:}
