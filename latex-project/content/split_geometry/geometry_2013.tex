...
\]
Find the fundamental group $\pi_1(\mathbb{R}^3 \setminus X)$.\marginnote{Linked circles (like the ones in $X$) are disjoint circles in $\mathbb{R}^3$ that cannot be separated. Formally, they have a non-zero linking number. This specific configuration is a form of the Hopf link.}
\end{exercise}
