...
Imagine flipping a series of light switches. Every turn, you pick one switch to flip. The first switch is picked with probability $1/2$, the second with probability $1/4$, and in general the $i$-th switch with probability $2^{-i}$.
