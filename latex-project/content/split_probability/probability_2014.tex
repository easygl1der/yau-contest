...
\begin{exercise}\label{probability:2014:1}
...
\begin{exercise}\label{probability:2014:2}
...
\begin{exercise}\label{probability:2014:3}
...
\begin{exercise}\label{probability:2014:4}
...
\begin{exercise}\label{probability:2014:5}
...
\begin{enumerate}
    \item Find the asymptotic distribution (after appropriate normalization) for the MLE of $p_2$.
    \item Construct the likelihood ratio test statistic for the null hypothesis that $p_1 = p_2 = p_3/3$ (the alternative is that $p_1 = p_2 = p_3/3$ is not true). What is the asymptotic distribution of your test statistic under null?
\end{enumerate}
\end{exercise}
...
\begin{exercise}\label{probability:2014:6}
...
\begin{exercise}\label{probability:2014:7}
...
\begin{enumerate}
    \item If $y > 0$, the inequality is $x \leq zy$.
    \item If $y < 0$, the inequality flips to $x \geq zy$.
\end{enumerate}
...
\begin{exercise}\label{probability:2014:8}
...
\begin{exercise}\label{probability:2014:9}
Let $X_1, ..., X_n$ be i.i.d. $N(0, \sigma^2)$, and let $M$ be the mean of $|X_1|, ..., |X_n|$.

\begin{enumerate}
    \item Find $c \in \mathbb{R}$ so that $\hat{\sigma} = cM$ is a consistent estimator of $\sigma$.
    \item Determine the limiting distribution for $\sqrt{n}(\hat{\sigma} - \sigma)$.
    \item Identify an approximate $(1-\alpha)\%$ confidence interval for $\sigma$.
    \item Is $\hat{\sigma} = cM$ asymptotically efficient? Please justify your answer.
\end{enumerate}
\end{exercise}
...
\begin{exercise}\label{probability:2014:10}
