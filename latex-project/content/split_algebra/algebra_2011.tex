...
\begin{enumerate}
\item $P_7$ is the group of upper triangular unipotent matrices (order $7^3$):
$P_7 = \{ \begin{pmatrix} 1 & a & b \\ 0 & 1 & c \\ 0 & 0 & 1 \end{pmatrix} \}$.
\item The normalizer $N(P_7)$ is the Borel subgroup $B$ of upper triangular matrices:
$B = \{ \begin{pmatrix} d_1 & a & b \\ 0 & d_2 & c \\ 0 & 0 & d_3 \end{pmatrix} : d_i \in \mathbb{F}_7^\times \}$.
\item Sylow 2-subgroup has order $2^6 = 64$.
