...
\begin{exercise}
Skin effect in a conducting medium.
\end{exercise}

\begin{center}
  \includegraphics[width=0.65\textwidth]{images/physics/3d2eaed279ce1032918d6e4d495a1dcbb18a8694d0399fe20866f318e430841d.jpg}
  \\
  \captionof{figure}{Electromagnetic wave reflection at conducting boundary}
\end{center}
...
\begin{exercise}
Ising model with infinite-range interactions.
\end{exercise}
...
\begin{exercise}
de Sitter space embedded in higher dimensions.
\end{exercise}
...
\begin{exercise}
Yukawa theory renormalization at one-loop order.
\end{exercise}
