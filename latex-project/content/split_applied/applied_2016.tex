...
\]
\item[(b)] Use expansions $s(t)=s_{0}(t)+\epsilon s_{1}(t)+O(\epsilon^{2})$, $c(t)=c_{0}(t)+\epsilon c_{1}(t)+O(\epsilon^{2})$, etc., to determine equations for leading order slow solution. Show $s_{0}(t)$ and $p_{0}(t)$ satisfy Michaelis-Menten equations:
\[
