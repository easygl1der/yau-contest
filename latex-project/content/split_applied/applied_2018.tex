...
\begin{enumerate}
    ...
    \item For the subgradient method $x_{k+1} = x_k - \alpha g_k$, assume $f$ is $L$-Lipschitz and $\|x_1 - x_*\| \leq B$. Show that
    \[
    \lim_{k \to \infty} f(x_k^{best}) \leq f(x_*) + \frac{L^2}{2}\alpha
    \]
\end{enumerate}
\end{exercise}
