...
\begin{tikzpicture}[remember picture, overlay, x=1cm, y=1cm]
    ...
    \node[
        ...
        \fontsize{48}{56}\selectfont\bfseries 2012%
    };
    ...
    \node[right, text=myDColor!80, anchor=north west] (T) at ($(current page.north west)+(2,-4.5)$){%
        \parbox{0.8\paperwidth}{%
            \fontsize{44}{52}\selectfont\bfseries Geometry\\[-3pt]
            \fontsize{36}{44}\selectfont\bfseries Topology\\[-3pt]
            \fontsize{28}{36}\selectfont\bfseries \& Topology 2012%
        }%
    };
    ...
    \node[right, text=myLColor!70, anchor=north west] at ($(current page.south west)+(2,1)$){%
        \footnotesize Geometry $\cdot$ Topology%
    };
\end{tikzpicture}
\vfill
