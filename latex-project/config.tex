...
% Compatibility environment used by older generated solution files.
...
% Compatibility for older imported TeX snippets.
...
% PDF metadata
\hypersetup{
    pdftitle={2010-2026 Past Exam Papers Collection},
    pdfauthor={Yue Yihua},
